...
SERVICE_NAME="ctp40-init.service"
SERVICE_PATH="/etc/systemd/system"
BINARY_NAME="ctp40-init"
ROTATE_NAME="ctp40-rotate"
BINARY_PATH="/usr/bin"
...
printf "\nBefore rebooting, use 'ctp40-rotate left/right/normal/inverted' to rotate your display!\n\n"
